...
import 'package:farwla/screens/home_screen.dart';
import 'package:farwla/screenss/screensss/list_screen.dart';
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: Row(
                ...
                children: [
                  _bottomAppBarIcon(index: 0, icon: Icons.home_outlined, text: "Home"),
                  Spacer(),
                  _bottomAppBarIcon(index: 1, icon: Icons.density_medium_outlined, text: "Services"),
                  Spacer(),
                  _bottomAppBarIcon(index: 2, icon: Icons.person_outline_outlined, text: "Profile"),
                ],
              ),
            ),
          ),
